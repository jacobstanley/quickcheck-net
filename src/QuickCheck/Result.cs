...
namespace QuickCheck
{
    ...
    public class Result
    {
        ...
        private Result(int tests, ulong seed, int size, TestArgs args, Exception error)
        {
            m_Tests = tests;
            m_Seed = seed;
            m_Size = size;
        ...
        public static Result Failure(int tests, ulong seed, int size, TestArgs args, Exception error)
        {
